...
function setupModalListeners() {
    ...
    links.forEach(link => {
        link.onclick = function(event) {
            ...
            // Remove the 'transformed' class when a modal is opened
    ...
    closes.forEach(close => {
        close.onclick = function() {
            ...
            // Add the 'transformed' class back when the modal is closed
    ...
    window.onclick = function(event) {
        modals.forEach(modal => {
            if (event.target == modal) {
                ...
                // Add the 'transformed' class back when the modal is closed by clicking outside
                document.body.classList.add('transformed');
            }
        });
    }
...
// Initial transformation application
document.body.classList.add('transformed');